...
export default async function ProPage() {
  ...
  const plan = effectivePlan(session.user.plan, session.user.subscriptionStatus);
        ...
        <section className="container-page py-8 sm:py-10 lg:py-12">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-7 border border-[#28292e] bg-[#111216] px-6 py-8 text-white sm:px-8 lg:grid lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end lg:gap-16 lg:px-10 lg:py-10">
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-brand-300">AnunciaAI Pro · Acesso antecipado</p>
                <h1 className="mt-3 max-w-3xl text-3xl font-semibold tracking-[-0.05em] sm:text-[2.8rem]">Compare versões antes de decidir qual caminho publicar.</h1>
              </div>
              <p className="mt-5 text-sm leading-7 text-white/52 lg:mt-0">O primeiro recurso exclusivo do Pro gera três abordagens do mesmo produto para comparação. Não há cobrança ativa durante o acesso antecipado.</p>
            </div>
