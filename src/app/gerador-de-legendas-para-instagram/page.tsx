...
const structuredData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Gerador de legendas para Instagram", item: ABSOLUTE_URL },
  ],
};
