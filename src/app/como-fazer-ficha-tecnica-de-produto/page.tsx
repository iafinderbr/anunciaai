        ...
        <article>
          ...
          <div className="container-page grid gap-12 py-12 lg:grid-cols-[minmax(0,1fr)_280px] lg:gap-16 lg:py-16">
            <div className="min-w-0">
              ...
              <section className="mt-16"><p className="text-xs font-semibold uppercase tracking-[0.14em] text-brand-600">Fonte dos dados</p><h2 className="mt-3 text-2xl font-semibold sm:text-3xl">Use a versão exata do produto como referência</h2><p className="mt-4 text-[15px] leading-7 text-muted">Comece pela etiqueta, embalagem, manual ou página oficial do fabricante referente ao mesmo modelo e à mesma variação que será vendida. Se duas versões têm nomes parecidos, confirme código, capacidade, voltagem, tamanho ou outro identificador antes de copiar uma especificação. Um anúncio de 127 V, por exemplo, não deve herdar dados de uma versão 220 V apenas porque as fotos parecem iguais.</p><p className="mt-4 text-[15px] leading-7 text-muted">Quando fornecedor e fabricante apresentarem valores diferentes, não escolha o número mais conveniente. Registre a divergência, confirme a fonte correta e só então publique. Essa rotina também facilita futuras atualizações: você sabe de onde cada dado veio e reduz o risco de misturar informações entre SKUs.</p></section>
