...
const guides = [
  ...
  { href: "/como-criar-titulo-para-shopee", eyebrow: "Shopee", title: "Como criar título para Shopee", description: "Fórmula prática, limite atual, exemplos por categoria, erros comuns e checklist para revisar o título antes de publicar.", readingTime: "7 min de leitura", topics: ["Até 120 caracteres", "4 exemplos", "Checklist"], toolHref: "/gerador-de-anuncios-shopee#ferramenta", toolLabel: "Gerar título para Shopee" },
  { href: "/como-fazer-descricao-para-shopee", eyebrow: "Shopee", title: "Como fazer descrição para Shopee", description: "Estrutura em quatro blocos, modelo editável, exemplo e checklist para criar uma descrição útil e fácil de ler.", readingTime: "7 min de leitura", topics: ["Modelo pronto", "Até 3.000 caracteres", "Checklist"], toolHref: "/gerador-de-anuncios-shopee#ferramenta", toolLabel: "Gerar descrição para Shopee" },
  ...
  { href: "/como-criar-titulo-para-olx", eyebrow: "OLX", title: "Como criar título para OLX", description: "Fórmula prática, limite de 90 caracteres, exemplos, erros comuns e checklist para deixar o título direto e fácil de identificar.", readingTime: "7 min de leitura", topics: ["Até 90 caracteres", "4 exemplos", "Checklist"], toolHref: "/gerador-de-anuncios-olx#ferramenta", toolLabel: "Gerar título para OLX" },
  { href: "/como-fazer-descricao-para-olx", eyebrow: "OLX", title: "Como fazer descrição para OLX", description: "Estrutura em quatro blocos, modelo editável, exemplo e checklist para explicar o estado do item e os detalhes da venda.", readingTime: "7 min de leitura", topics: ["Modelo pronto", "Até 6.000 caracteres", "Checklist"], toolHref: "/gerador-de-anuncios-olx#ferramenta", toolLabel: "Gerar descrição para OLX" },
  ...
  { href: "/como-criar-titulo-para-facebook-marketplace", eyebrow: "Facebook Marketplace", title: "Como criar título para Facebook Marketplace", description: "Fórmula prática, exemplos e checklist para identificar o item com clareza sem inventar um limite oficial de caracteres.", readingTime: "6 min de leitura", topics: ["Fórmula", "4 exemplos", "Condição"], toolHref: "/gerador-de-anuncios-facebook-marketplace#ferramenta", toolLabel: "Gerar título para Marketplace" },
  { href: "/como-fazer-descricao-para-facebook-marketplace", eyebrow: "Facebook Marketplace", title: "Como fazer descrição para Facebook Marketplace", description: "Modelo editável e checklist para explicar condição, características, defeitos e itens incluídos no classificado.", readingTime: "6 min de leitura", topics: ["Modelo pronto", "Condição", "Políticas da Meta"], toolHref: "/gerador-de-anuncios-facebook-marketplace#ferramenta", toolLabel: "Gerar descrição para Marketplace" },
  ...
  { href: "/seo-para-pagina-de-produto", eyebrow: "Loja virtual", title: "SEO para página de produto", description: "Checklist de conteúdo e sinais técnicos para ajudar compradores e mecanismos de busca a entender preço, disponibilidade e informações do produto.", readingTime: "7 min de leitura", topics: ["8 pontos", "Product/Offer", "SEO técnico"], toolHref: "/gerador-de-anuncios-para-loja-virtual#ferramenta", toolLabel: "Gerar conteúdo para loja" },
  { href: "/como-fazer-ficha-tecnica-de-produto", eyebrow: "Loja virtual", title: "Como fazer ficha técnica de produto", description: "Modelo por grupos, campos por categoria, exemplo e checklist para organizar especificações sem inventar dados.", readingTime: "7 min de leitura", topics: ["Modelo", "Especificações", "Checklist"], toolHref: "/gerador-de-anuncios-para-loja-virtual#ferramenta", toolLabel: "Gerar ficha técnica" },
      ...
      <main id="ferramenta">
        <section aria-labelledby="guias-titulo" className="relative overflow-hidden border-b border-line bg-white">
          ...
          <div className="container-page relative py-10 sm:py-16">
            <nav aria-label="Trilha de navegação"><ol className="flex items-center gap-2 text-xs text-muted"><li><Link href="/" className="transition-colors hover:text-ink">Início</Link></li><li aria-hidden="true">/</li><li aria-current="page" className="font-medium text-ink-soft">Guias</li></ol></nav>
            <div className="mx-auto mt-10 max-w-3xl text-center">
              <p className="inline-flex rounded-full border border-line-strong bg-canvas px-3 py-1.5 text-xs font-semibold text-brand-600 shadow-card">Conteúdo gratuito para quem vende online</p>
              <h1 id="guias-titulo" className="mt-6 text-[2.25rem] font-semibold leading-[1.06] sm:text-5xl lg:text-[3.65rem]">Guias práticos para criar anúncios melhores</h1>
              <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted sm:text-lg">Aprenda o processo, veja exemplos e use modelos prontos para apresentar seus produtos com clareza em lojas virtuais e marketplaces.</p>
              <a href="#todos-os-guias" className="mt-8 inline-flex rounded-2xl bg-ink px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-brand-600">Ver todos os guias</a>
            </div>
          </div>
        </section>
        ...
        <section id="todos-os-guias" aria-labelledby="todos-titulo" className="container-page scroll-mt-24 py-14 sm:py-20">
          <div className="max-w-2xl">
            ...
            <h2 id="todos-titulo" className="mt-3 text-2xl font-semibold sm:text-3xl">Escolha por onde começar</h2>
            <p className="mt-3 text-[15px] leading-relaxed text-muted">Cada conteúdo ensina uma tarefa completa e termina na ferramenta gratuita que ajuda você a executar.</p>
          </div>
            ...
            {guides.map((guide, index) => (
              <article key={guide.href} className="flex flex-col rounded-3xl border border-line bg-white p-6 shadow-card sm:p-8">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="grid size-9 place-items-center rounded-xl bg-ink text-xs font-semibold text-white">{String(index + 1).padStart(2, "0")}</span>
                </div>
                <h2 className="mt-5 text-2xl font-semibold leading-tight"><Link href={guide.href} className="transition-colors hover:text-brand-600">{guide.title}</Link></h2>
                <p className="mt-4 text-[15px] leading-7 text-muted">{guide.description}</p>
                <ul className="mt-5 flex flex-wrap gap-2">{guide.topics.map((topic) => <li key={topic} className="rounded-full border border-line bg-canvas px-3 py-1.5 text-xs font-medium text-ink-soft">{topic}</li>)}</ul>
                ...
                <div className="mt-7 flex flex-col gap-3 border-t border-line pt-6 sm:flex-row">
                  <Link href={guide.href} className="rounded-xl bg-ink px-4 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-brand-600">Ler o guia</Link>
                  <Link href={guide.toolHref} className="rounded-xl border border-line-strong px-4 py-3 text-center text-sm font-semibold text-ink transition-colors hover:border-brand-500 hover:text-brand-600">{guide.toolLabel}</Link>
                </div>
              </article>
            ))}
          </div>
        ...
        <section aria-labelledby="guias-cta-titulo" className="container-page py-14 sm:py-20">
          <div className="rounded-3xl bg-ink px-6 py-12 text-center sm:px-12">
            ...
            <p className="mx-auto mt-3 max-w-xl text-[15px] leading-relaxed text-white/70">Escolha uma das ferramentas gratuitas e transforme as informações do produto em um texto pronto para revisar.</p>
            <Link href="/#ferramentas" className="mt-7 inline-flex rounded-2xl bg-white px-7 py-4 text-base font-semibold text-ink transition-colors hover:bg-brand-500 hover:text-white">Ver ferramentas gratuitas</Link>
          </div>
        </section>
      </main>
      <SiteFooter />
