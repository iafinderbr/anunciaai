...
const DESCRIPTION =
  "Aprenda a criar nomes, anúncios, títulos, descrições, benefícios, CTAs, hashtags e palavras-chave de produtos com guias práticos.";
...
const guides = [
  ...
  { href: "/como-criar-anuncio-no-facebook-marketplace", eyebrow: "Facebook Marketplace", title: "Como criar um anúncio no Facebook Marketplace", description: "Organize fotos, título, preço, categoria, condição, descrição e revisão para apresentar o item com clareza.", readingTime: "8 min de leitura", topics: ["8 etapas", "Condição", "Checklist"], toolHref: "/gerador-de-anuncios-facebook-marketplace#ferramenta", toolLabel: "Gerador para Marketplace" },
  { href: "/como-criar-titulo-para-facebook-marketplace", eyebrow: "Facebook Marketplace", title: "Como criar título para Facebook Marketplace", description: "Fórmula prática, exemplos e checklist para identificar o item com clareza e sem exageros.", readingTime: "6 min de leitura", topics: ["Fórmula", "4 exemplos", "Condição"], toolHref: "/gerador-de-anuncios-facebook-marketplace#ferramenta", toolLabel: "Gerar título para Marketplace" },
  { href: "/como-fazer-descricao-para-facebook-marketplace", eyebrow: "Facebook Marketplace", title: "Como fazer descrição para Facebook Marketplace", description: "Modelo editável e checklist para explicar condição, características, defeitos e itens incluídos no classificado.", readingTime: "6 min de leitura", topics: ["Modelo pronto", "Condição", "Checklist"], toolHref: "/gerador-de-anuncios-facebook-marketplace#ferramenta", toolLabel: "Gerar descrição para Marketplace" },
  ...
  { href: "/como-fazer-descricao-para-loja-virtual", eyebrow: "Loja virtual", title: "Como fazer descrição para loja virtual", description: "Estrutura em cinco blocos, modelo editável, erros comuns e checklist para apresentar o produto com clareza.", readingTime: "7 min de leitura", topics: ["5 blocos", "Modelo", "Checklist"], toolHref: "/gerador-de-anuncios-para-loja-virtual#ferramenta", toolLabel: "Gerar conteúdo para loja" },
  { href: "/como-escrever-beneficios-de-produto", eyebrow: "Loja virtual", title: "Como escrever benefícios de produto", description: "Método para transformar características confirmadas em utilidade sem criar promessas que o produto não sustenta.", readingTime: "6 min de leitura", topics: ["Fórmula", "4 exemplos", "Checklist"], toolHref: "/gerador-de-anuncios-para-loja-virtual#ferramenta", toolLabel: "Gerar benefícios" },
        ...
        <section aria-labelledby="guias-titulo" className="relative overflow-hidden border-b border-line bg-white">
          ...
          <div className="container-page relative py-10 sm:py-16">
            ...
            <div className="mx-auto mt-10 max-w-3xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted sm:text-lg">Aprenda o processo, veja exemplos e use modelos prontos para apresentar seus produtos com clareza em lojas virtuais, marketplaces e redes sociais.</p>
