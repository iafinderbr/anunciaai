...
const guides = [
  {
    ...
    description: "Passo a passo para organizar categoria, título, fotos, ficha técnica, descrição, preço e revisão antes de publicar.",
  ...
  },
  {
    ...
    description: "Passo a passo para organizar categoria, título, fotos, atributos, variações, descrição, preço e revisão antes de publicar.",
    readingTime: "8 min de leitura",
  ...
  },
  {
    ...
    description: "Guia atualizado para organizar título, fotos, categoria, descrição, preço, localização e revisão antes de publicar.",
    readingTime: "8 min de leitura",
  ...
  {
    href: "/como-criar-anuncio-no-facebook-marketplace",
    eyebrow: "Facebook Marketplace",
    title: "Como criar um anúncio no Facebook Marketplace",
    description: "Guia baseado na Central de Ajuda da Meta para organizar fotos, título, preço, categoria, condição, descrição e revisão.",
    readingTime: "8 min de leitura",
    topics: ["8 etapas", "Políticas da Meta", "Condição do item"],
    toolHref: "/gerador-de-anuncios-facebook-marketplace#ferramenta",
    toolLabel: "Gerador para Marketplace",
  },
  {
    href: "/como-criar-pagina-de-produto-para-loja-virtual",
    eyebrow: "Loja virtual",
    title: "Como criar uma página de produto para loja virtual",
    description: "Passo a passo para montar título, imagens, benefícios, descrição, ficha técnica, SEO e revisão da página de produto.",
    readingTime: "9 min de leitura",
    topics: ["8 etapas", "Modelo pronto", "SEO de produto"],
    toolHref: "/gerador-de-anuncios-para-loja-virtual#ferramenta",
    toolLabel: "Gerador para loja virtual",
  },
  {
    href: "/como-fazer-descricao-de-produto",
    eyebrow: "Descrição de produto",
    title: "Como fazer uma descrição de produto",
    description: "Estrutura completa, modelo editável e exemplos para transformar informações verdadeiras em um texto claro e persuasivo.",
    readingTime: "9 min de leitura",
  ...
  },
  {
    ...
    description: "Fórmula em quatro partes, modelos por categoria, regras por canal e exemplos para deixar cada versão fácil de identificar.",
    readingTime: "8 min de leitura",
  ...
  },
  {
    ...
    description: "Método em seis etapas para encontrar termos principais, atributos e cauda longa sem repetição artificial.",
    readingTime: "9 min de leitura",
  ...
  {
    href: "/como-criar-nome-de-produto",
    eyebrow: "Nome de produto",
    title: "Como criar nome de produto",
    description: "Briefing, estilos, critérios de avaliação, exemplos fictícios e cuidados antes de lançar um nome no mercado.",
    readingTime: "9 min de leitura",
    topics: ["Método prático", "6 exemplos", "Verificação"],
    toolHref: "/gerador-de-nomes-para-produtos#ferramenta",
    toolLabel: "Gerador de nomes",
  },
];
  ...
  "@graph": [
    {
      ...
      url: ABSOLUTE_URL,
      inLanguage: "pt-BR",
      hasPart: guides.map((guide) => ({ "@type": "Article", headline: guide.title, url: `${SITE_URL}${guide.href}` })),
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {guides.map((guide, index) => (
              <article key={guide.href} className="flex flex-col rounded-3xl border border-line bg-white p-6 shadow-card sm:p-8">
                <div className="flex items-center justify-between gap-4"><p className="text-xs font-semibold uppercase tracking-[0.12em] text-brand-600">{guide.eyebrow}</p><span className="grid size-9 place-items-center rounded-xl bg-ink text-xs font-semibold text-white">{String(index + 1).padStart(2, "0")}</span></div>
