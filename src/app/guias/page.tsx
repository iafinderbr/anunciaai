...
const guides = [
  ...
  },
  {
    ...
    description:
      "Guia baseado na Central de Ajuda da Meta para organizar fotos, título, preço, categoria, condição, descrição e revisão.",
    readingTime: "8 min de leitura",
  ...
  },
  {
    ...
    description:
      "Briefing, estilos, critérios de avaliação, exemplos fictícios e cuidados antes de lançar um nome no mercado.",
    readingTime: "9 min de leitura",
