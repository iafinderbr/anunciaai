...
const guideCollections = [
  ...
  { title: "Loja virtual", links: [["/como-criar-pagina-de-produto-para-loja-virtual", "Criar página de produto"],["/seo-para-pagina-de-produto", "SEO para produto"],["/como-fazer-ficha-tecnica-de-produto", "Fazer ficha técnica"]] },
  { title: "Conteúdo e redes sociais", links: [["/como-criar-legenda-para-instagram", "Legenda para Instagram"],["/como-criar-nome-de-produto", "Criar nome de produto"],["/como-criar-titulo-de-produto", "Criar título de produto"],["/como-fazer-descricao-de-produto", "Fazer descrição de produto"],["/como-escolher-palavras-chave-para-produtos", "Escolher palavras-chave"]] },
] as const;
